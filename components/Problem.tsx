  ...
  return (
    <section className="bg-white py-24 px-6 border-b border-gray-100">
      <div className="max-w-4xl mx-auto text-center space-y-12">
        <h2 className="text-4xl md:text-5xl font-extrabold text-[#151819]">The Problem with January 1st</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="space-y-4 p-8 rounded-2xl bg-[#EDEFF7]/50 hover:bg-[#EDEFF7] transition-colors border border-transparent hover:border-[#BCBFCC]/30">
            ...
            <p className="text-[#151819] font-medium leading-relaxed">
        ...
        <div className="pt-8 max-w-2xl mx-auto">
          <p className="text-xl text-[#151819]/70 leading-relaxed italic">

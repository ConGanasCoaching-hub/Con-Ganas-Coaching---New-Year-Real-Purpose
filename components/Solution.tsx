...
const Solution: React.FC = () => {
  // New high-quality static image replacing the video
  const imageId = "1CaJMGOajPr52Gint8XK5mIK6efhasiOc";
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16 items-center">
        <div className="relative group order-2 lg:order-1">
          <div className="aspect-[4/5] bg-gray-200 rounded-3xl overflow-hidden shadow-2xl transition-all duration-700">
            <img 
              src={imageUrl}
              alt="Con Ganas Coaching - Mindset Driven Transformation"
          ...
          <div className="absolute -bottom-6 -right-6 bg-white p-6 rounded-2xl shadow-xl border border-gray-100 max-w-[280px] hidden md:block z-10">
            ...
            <p className="text-sm text-[#151819] font-semibold leading-relaxed">
        ...
        <div className="space-y-6 md:space-y-8 order-1 lg:order-2">
          <div className="space-y-2 text-center lg:text-left">
            ...
            <h2 className="text-3xl md:text-5xl font-black text-[#151819] leading-tight">
              Hi, I’m Ivan. <br />
          ...
          <div className="space-y-6 text-center lg:text-left">
            <p className="text-base md:text-lg text-[#151819]/80 leading-relaxed">
              <strong className="text-[#AF630B] font-black uppercase tracking-wider">Con Ganas</strong> means "with desire," "with zeal," and "with intention".
            </p>
            
            <p className="text-base md:text-lg text-[#151819]/80 leading-relaxed font-light">
